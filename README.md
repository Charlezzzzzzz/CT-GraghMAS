...
CT-GraphMAS 是一个面向初中 Python 编程学习的知识图谱增强多智能体辅导系统原型。系统采用纯 Python 标准库后端、SQLite 本地数据库和淡蓝色像素风 Web 前端，拥有登录流程、角色化导航、学生伴学、教师工作台、知识图谱、语料库、设置页面、管理中心、三层多智能体协同、动态图谱路由、少量相关知识注入、上传语料切分、 embedding、初步反代写教学门控等功能。
